                ...
                .setPositiveButton("Save", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which)
                    {
...

                        {
                            ...
                            Toast.makeText(getContext(), "Name Must be 5 Letters", Toast.LENGTH_SHORT).show();


                         if((editTextUst.getText().toString().length()<1) || (editTextUst.getText().toString().length()>50))
                         {
                             Toast.makeText(getContext(), "Name Must be 1 Letters", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(getContext(), "Click Update Button To Save", Toast.LENGTH_SHORT).show();
